...
<section id="menu" class="p-6">
  <div class="max-w-screen-xl mx-auto">
          ...
          <div class="p-5 flex flex-col gap-3">
            ...
            <div class="space-y-1">
              ...
              <div class="flex justify-between items-center">
                ...
                <span class="price">Harga: Rp. {{ number_format($menu->price, 0, ',', '.') }}</span>
              </div>
              <!-- <p class="text-sm text-neutral-500 font-inter font-normal">
                {{ $menu->description }}
              </p> -->
              <div class="flex items-center gap-2">
                <a class="basis-1/2 btn-pesan" href="https://logbookjti.policaltex.id/"> Pesan </a>
    ...
    <div class="text-center p-2" id="btn-transform">
      <a href="{{ route('menu.menu') }}" class="btn-transform">Lihat Menu</a>
    </div>
  </div>
</section>