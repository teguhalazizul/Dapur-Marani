          ...
          <div class="md:flex md:items-center md:gap-12">
            <nav aria-label="Global" class="hidden md:block">
              <ul class="flex items-center gap-6 text-sm">
                <li>
                  <a class="link" href="{{ route('homepage') }}"> Home </a>
                </li>

                <li>
                  <a class="link" href="{{ route('homepage') }}"> About Us </a>
                </li>

                <li>
                  <a class="link" href="{{ route('homepage') }}"> Menu </a>
                </li>
                <li>
                  <a class="link" href="{{ route('homepage') }}"> Artikel </a>
                </li>

                <li>
                  <a class="link" href="{{ route('homepage') }}"> Pesan Saran </a>
                </li>
                <li>
                  <a class="link" href="{{ route('homepage') }}"> Kontak </a>
                </li>
              </ul>
            </nav>
